<template>
  <div id="app">
    ...
    <div class="uk-container">
      <div class="footer">
        <div>Site created by Antky from <a href="https://aaleks.ru" rel="noreferrer">antky.ru</a></div>
        <div>
          Icons made by <a href="https://www.freepik.com/" title="Freepik" rel="noreferrer">Freepik</a> from <a href="https://www.flaticon.com/" rel="noreferrer" title="Flaticon">www.flaticon.com</a> is licensed by <a href="http://creativecommons.org/licenses/by/3.0/" rel="noreferrer" title="Creative Commons BY 3.0" target="_blank">CC 3.0 BY</a>
        </div>
